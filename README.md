...
🧪 Kubernetes manifests for deploying a Java application and MySQL database
📄 Setup instructions for Role-Based Access Control (RBAC)
🔧 Maven configuration and wrapper for building Java code
